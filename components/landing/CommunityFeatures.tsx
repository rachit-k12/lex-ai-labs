...
const features = [
  {
    ...
    description: 'Live sessions with AI practitioners from top companies. Ask questions, get insights, and learn from real-world experience.',
    tag: 'Every Thursday',
  ...
  },
  {
    ...
    description: 'Small group sessions with peers at similar career stages. Accountability, feedback, and deep discussions.',
    tag: '8-person groups',
  ...
  },
  {
    ...
    description: 'AI roles from our network of 50+ companies. Get referrals from community members working at your target companies.',
    tag: 'Members only',
  ...
  },
  {
    ...
    description: 'Monthly in-person meetups in Bengaluru, Mumbai, and Delhi. Network, learn, and make lifelong connections.',
    tag: '3 Cities',
  ...
  },
  {
    ...
    description: 'Active Slack workspace with channels for job opportunities, tech discussions, startup advice, and more.',
    tag: '24/7 Access',
  ...
  },
  {
    ...
    description: 'Structured learning with the AI Fellowship and AI for Leaders programs. Build skills with community support.',
    tag: 'Monthly cohorts',
